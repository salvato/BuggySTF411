...
// *  different.  maybe they'll  be doing a time window and will need
// *  0-8000 or something.  or maybe they'll want to clamp it from 0-125.
...
// * We need to know which one, because otherwise we may increase
// * the output when we should be decreasing.
